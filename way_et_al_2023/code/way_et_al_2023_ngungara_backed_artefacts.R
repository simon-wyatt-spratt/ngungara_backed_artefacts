...
# artefacts? An example from Ngungara (Weereewa/Lake George), 
...
# Ngungara (Weereewa/Lake George), in Southeastern Australia, which has both 
# locally manufactured and imported backed artefacts. These local and imported 
# artefacts are found side-by-side within well-bounded stone artefact 
